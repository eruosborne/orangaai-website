...
(function () {
  ...
  var KB = [
    ...
    },
    {
      ...
      answer: "Oranga AI installs <strong>Oranga Core</strong> — an AI operating system for your business. It's one workspace that knows your business, does the routine work, and never acts alone on anything that matters. We build it, install it, tune it to how you actually run, and stand behind it."
    },
    {
    ...
    },
    {
      ...
      answer: "Oranga Core is built for small, owner-operated service businesses — trades, allied health, real estate, brokerages, cleaning, coaching. The kind where the owner still holds most of the business in their head, and the admin between the real work is what's eating the week."
    },
    {
      ...
      answer: "An install runs in five steps:<br><br><strong>1. Intake</strong> — understanding your business, tools, and real pinch points.<br><strong>2. Build</strong> — your knowledge layer drafted from your own mail and documents; tools linked; your writing style captured.<br><strong>3. Test</strong> — proven on real low-stakes work first, including a deliberate test that a broken connection fails loudly.<br><strong>4. Handover</strong> — you and your team know how to run it.<br><strong>5. 30 days support</strong> — then an ongoing monthly retainer, because a system like this needs tending."
    },
    {
      ...
      answer: "Oranga Core is priced as a <strong>one-time build fee plus a monthly retainer</strong> — the same shape as bringing on a very capable, very fast operations hire, without the headcount. We confirm the exact figure on your free strategy call, once we've seen what you actually need."
    },
    {
